                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <form id="register-form" action="index.php?page=register" method="post" role="form">
                                ...
                                <div class="form-group">
                                    <input type="text" name="adresse" id="adresse" tabindex="1" class="form-control" placeholder="adresse" value="" required="true">
                                </div>
                                <div class="form-group">
                                    <input type="text" name="ville" id="ville" tabindex="1" class="form-control" placeholder="ville" value="" required="true">
                                </div>
                                <div class="form-group">
                                    <input type="text" name="code_postal" id="code_postal" tabindex="1" class="form-control" placeholder="code_postal" value="" required="true">
                                </div>
                                <div class="form-group">
